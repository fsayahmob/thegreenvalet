        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="mt-5 flex items-center gap-3">
              <a
                href="https://www.instagram.com/thegreenvalet"
                target="_blank"
                rel="noopener noreferrer"
                className="h-9 w-9 rounded-lg bg-charcoal-800 flex items-center justify-center hover:bg-charcoal-700 transition-colors"
              ...
              <a
                href="https://www.linkedin.com/company/thegreenvalet"
                target="_blank"
                rel="noopener noreferrer"
                className="h-9 w-9 rounded-lg bg-charcoal-800 flex items-center justify-center hover:bg-charcoal-700 transition-colors"
                aria-label="LinkedIn"
